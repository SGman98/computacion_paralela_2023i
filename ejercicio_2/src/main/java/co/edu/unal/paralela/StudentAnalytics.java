...
public final class StudentAnalytics {
   ...
   * streams paralelos. Debe reflejar la funcionalidad de averageAgeOfEnrolledStudentsImperative.
   * Este método NO debe utilizar ciclos.
   *
  ...
  /**
   * Calcula secuencialmente -usando ciclos- el nombre más común de todos los estudiantes que no
   * están activos en la clase.
   *
   * @param studentArray Datos del estudiante para esta clase.
  ...
  /**
   * PARA HACER calcula el nombre más común de todos los estudiantes que no están activos en la
   * clase utilizando streams paralelos. Debe reflejar la funcionalidad de
   * mostCommonFirstNameOfInactiveStudentsImperative. Este método NO debe usar ciclos
   *
  ...
  /**
   * calcula secuencialmente el número de estudiantes que han perdido el curso que son mayores de 20
   * años. Una calificación de perdido es cualquiera por debajo de 65 65. Un estudiante ha perdido
   * el curso si tiene una calificación de perdido y no está activo en la actuialidad
   *
   * @param studentArray Datos del estudiante para la clase.
  ...
  /**
   * PARA HACER calcular el número de estudiantes que han perdido el curso que son mayores de 20
   * años de edad . una calificación de perdido está por debajo de 65. Un estudiante ha perdido el
   * curso si tiene una calificación de perdido y no está activo en la actuialidad. Debe reflejar la
   * funcionalidad de countNumberOfFailedStudentsOlderThan20Imperative. El método no debe usar
   * ciclos.
   *
   * @param studentArray Datos del estudiante para la clase.
   * @return Cantidad de calificacione sperdidas de estudiantes mayores de 20 años de edad.
